export function bearerHeaders(accessToken: string | undefined, extra?: Record<string, string>): Record<string, string> {
...
const SESSION_CACHE_PREFIX = "truckinzy-boardapp:sessionCache:"
